...
class Coin:
    ...
    def worth(self):
        ...
        return self.cents + inc if inc > 0 else self.cents
...
class VendingMachine:
    ...
    def vend(self):
        ...
        if change < 0:
            return f'You must deposit ${-change} more.'
        self.stock -= 1
        self.balance = 0
        base_notice = f'Here is your {self.product}'
        return f'{base_notice}.' if change == 0 else f'{base_notice} and ${change} change.'
